...
export default function Landing({ display }: { display: boolean }) {
    ...
    return (
        <main className={`flex font-poppins justify-center text-light-100 h-80screen md:h-screen mb-20`} style={{minHeight:'200px'}}>
            <div className={`w-full mt-40 md:mt-72`}>
                ...
                <div className={`flex mt-14 delay-1000 font-chivo ${dis} ${anim}`} >
                    <div className='px-6 py-3 border border-light-100 rounded-md cursor-pointer transition-all ease-out duration-500 hover:bg-light-100 hover:bg-opacity-30'>
