...
export default function About() {
  ...
  return (
    ...
    }} style={{ minHeight: '200px' }} className={`duration-700 h-80screen 2xl:px-10 transition-up ${anim} ${display ? ' opacity-100 translate-x-0 translate-y-0 ' : 'opacity-0 translate-y-24 translate-x-24'}`}>
