...
export default function About() {
  ...
  return (
    ...
    }} style={{ minHeight: '800px' }} className={` duration-700 h-80screen 2xl:px-10 transition-up ${display ? ' opacity-100 translate-x-0 translate-y-0 ' : 'opacity-0 translate-y-8 translate-x-8 md:translate-y-24 md:translate-x-24'}`}>
