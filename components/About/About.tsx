...
let text = `Hello! As a full-stack developer with over three years of experience, I've worked on multiple type of applications and specialize in both frontend and backend technologies. Here are some of the type of projects ive worked on: NFT, DeFi, trading bots, web scraping, Chrome checkout tools, and Apis/Backend services.`
