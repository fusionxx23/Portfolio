      ...
      >
        <section className="w-full flex flex-col justify-start h-full p-4 sm:p-6">
          <div>
              ...
              <div className="text-light-200 flex">
                {link && (
                  <Link rel="noopener noreferrer" target="_blank" href={link}>
                    <GoLinkExternal
                      className="cursor-pointer mx-1 hover:text-light-100"
                      size={20}
                    />
                  </Link>
                )}
                {github && (
                  <Link rel="noopener noreferrer" target="_blank" href={github}>
                    <FiGithub
                      className="cursor-pointer ml-1 hover:text-light-100"
                      size={20}
                    />
                  </Link>
                )}
            ...
            <h1 className="text-light-200 mt-4 text-2xl font-chivo hover:text-light-100">
              {title}
            </h1>
          </div>
          ...
          <div className="flex justify-center">
            <div className="mt-4 relative cursor-pointer">
              ...
              ></div>
              <Image
                className="rounded-md z-0 transition-all ease-in "
                src={img}
                alt={title}
          ...
          <div className=" flex flex-col">
            ...
            <div className="flex">
              {icons.map((I, i) => (
                <I className="text-light-200 m-2" size={20} key={i} />
              ))}
            </div>
          </div>
        </section>
